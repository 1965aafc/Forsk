    ...
    <div class="btmmenu">
        <div class="container">
            <ul class="btmnav">
                ...
                <li><a href="contact.php" class="btactive">Contact us</a></li>
            </ul>
        </div>
    </div>

    <div class="sec-banner txt-center"><img src="images/home_company_career.jpg" width="100%"/> </div>


			<div class="container">
                <div class="pagecontent txt-center col-md-12">
                    <h1 class="wow fadeInUp txt-center" data-wow-delay="0.4s">Let's Talk</h1>


                    <div class="contact main">

                        <p class="wow fadeInUp animated animated" data-wow-delay="0.4s">…about your hardest science and data strategy challenges<br>
…about applying artificial intelligence to speed innovation</p><br><p><b>Fill out the form below and we'll be in touch</b></p>
                        <form class="wow fadeInUp animated" data-wow-delay="0.4s" onsubmit="return send_message()" id="ff">
                            ...
                            <input type="text" class="text" value="Describe" id="msg" onfocus="this.value = '';" onblur="    if (this.value == '') { this.value = 'Describe Yourself'; }">
