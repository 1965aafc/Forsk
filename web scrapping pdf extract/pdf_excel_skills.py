# -*- coding: utf-8 -*-
"""
Created on Tue Mar 26 16:16:24 2019
...
for x in range(417):
    ...
    skills_t=browser.find_element_by_class_name('skills_container').text.split()
    
    if("more.." in skills_t):
         skill=browser.find_element_by_class_name('show_all_skills').click()
         skills_tt=browser.find_element_by_class_name('skills_container').text
    else:
        skills_tt=browser.find_element_by_class_name('skills_container').text
